...
//this class to store all image drawable resources in ArrayLists

public class AndroidImage {

    //list all android img broken down to head , body and legs

    private static final List<Integer> body = new ArrayList<Integer>(){{
    ...
    private static final List<Integer> head = new ArrayList<Integer>(){{
    ...
    // getter function get list of head img , body img , legs img
    ...
    //get list of all img combined :-  body img , head img , leg img in this order
